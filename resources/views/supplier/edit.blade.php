            ...
            <div class="card">
                <div class="card-body">								
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="qty_baru">Tambah Stok(KG)</label>
                                <input type="text" name="qty_baru" id="qty_baru" class="form-control" placeholder="Kuantiti">	
                                <p></p>
                            </div>	
                        </div>						
                    </div>
...
$("#editSupplierProductForm").submit(function(event){
    ...
    $.ajax({
        url: '{{ route("supplier-products.update", $supplierProduct->id) }}',
        type: 'put',
