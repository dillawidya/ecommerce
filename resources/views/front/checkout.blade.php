    ...
    <div class="container">
        <div class="light-font">
            <ol class="breadcrumb primary-color mb-0">
                ...
                <li class="breadcrumb-item" style="color: #ffa500;"><i class="fas fa-home" style="margin-right: 5px"></i>Checkout</li>
                                        ...
                                        <select name="city" id="city" class="form-control">
                                            ...
                                            @if ($cities->isNotEmpty())
                                                @foreach ($cities as $city)
                                                    <option {{ (!empty($customerAddress) && $customerAddress->city_id == $city->id) ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        <p></p>
                    ...
                    <div class="card cart-summery">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between pb-2">
                                ...
                                <div class="h6">Rp. {{ number_format($item->price*$item->qty) }}</div>
                            </div>
                            @endforeach

                            <div class="d-flex justify-content-between summery-end">
                                <div class="h6"><strong>Subtotal</strong></div>
                                <div class="h6"><strong>Rp. {{ number_format(Cart::subtotal(0,'.','')) }}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between summery-end">
                                <div class="h6"><strong>Discount</strong></div>
                                <div class="h6"><strong id="discount_value">Rp. {{ number_format($discount) }}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                                <div class="h6"><strong>Shipping</strong></div>
                                <div class="h6"><strong id="shippingAmount">Rp. {{ number_format($totalShippingCharge) }}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 summery-end">
                                <div class="h5"><strong>Total</strong></div>
                                <div class="h5"><strong id="grandTotal">Rp. {{ number_format($grandTotal) }}</strong></div>
                            </div>                            
                        </div>
                    </div>   
    ...
    <script>
        ...
        $("#apply-discount").click(function(){
            $.ajax({
                ...
                type: 'post',
                data: {code: $("#discount_code").val(), city_id: $("#city").val()},
                dataType: 'json',
                success: function(response) {
                    if (response.status == true) {
                        $("#shippingAmount").html('Rp. '+response.shippingCharge);
