                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="mb-4 fs-sm fw-bold">
                                            <a class="text-body" href="product.html">{{ $item->name }} x 1</a> <br>
                                            <span class="text-muted">Rp. {{number_format($item->total)  }}</span>
                                        </p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <li class="list-group-item d-flex">
                                <span>Subtotal</span>
                                <span class="ms-auto">Rp. {{ number_format($order->subtotal) }}</span>
                            </li>
                            <li class="list-group-item d-flex">
                                <span>Discount{{ (!empty($order->coupon_code)) ? '('.$order->coupon_code.')' : ''}}</span>
                                <span class="ms-auto">Rp. {{ number_format($order->discount) }}</span>
                            </li>
                            <li class="list-group-item d-flex">
                                <span>Shipping</span>
                                <span class="ms-auto">Rp. {{ number_format($order->shipping) }}</span>
                            </li>
                            <li class="list-group-item d-flex fs-lg fw-bold">
                                <span>Total</span>
                                <span class="ms-auto">Rp. {{ number_format($order->grand_total) }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
