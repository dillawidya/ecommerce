    ...
    <div class="container">
        <div class="light-font">
            <ol class="breadcrumb primary-color mb-0">
                ...
                <li class="breadcrumb-item" style="color: #dbb143;"><i class="fas fa-home" style="margin-right: 5px"></i>My Profile</li>
                                    ...
                                    <select name="city_id" id="city_id" class="form-control">
                                        ...
                                        @if ($cities->isNotEmpty())
                                            @foreach ($cities as $city)
                                                <option {{ (!empty($address) && $address->city_id == $city->id) ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <p></p>
            ...
            success: function(response) {
                if (response.status == true) {
                    ...
                    if (errors.first_name) {
                        ...
                        .siblings('p').html(errors.first_name)
                        .addClass('invalid-feedback');
                    } else {
                    ...
                    if (errors.last_name) {
                        ...
                        .siblings('p').html(errors.last_name)
                        .addClass('invalid-feedback');
                    } else {
                    ...
                    if (errors.city_id) {
                        ...
                        .siblings('p').html(errors.city_id)
                        .addClass('invalid-feedback');
                    } else {
                    ...
                    if (errors.address) {
                        ...
                        .siblings('p').html(errors.address)
                        .addClass('invalid-feedback');
                    } else {
                    ...
                    if (errors.apartment) {
                        ...
                        .siblings('p').html(errors.apartment)
                        .addClass('invalid-feedback');
                    } else {
