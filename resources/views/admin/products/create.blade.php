...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
        <form action="post" name="productForm" id="productForm">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="title" id="title" class="form-control">
                                                ...
                                                @if ($title->isNotEmpty())
                                                    ...
                                                    <option value="{{ $item->id }}">{{ $item->nama_resep }} Rp. {{ number_format($item->total_harga) }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            <p class="error"></p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="make" id="make" cols="30" rows="10" class="summernote" placeholder="How To Make"></textarea>
                                        </div>
                                    </div>                                            
                                </div>
                            </div>	                                                                      
